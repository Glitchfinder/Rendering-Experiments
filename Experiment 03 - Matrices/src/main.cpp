...
void draw(GLuint, GLuint, GLuint, glm::mat4);
...
int main() {
	...
	const char* fShader = "SingleColor.fshader";
...
void draw(GLuint pid, GLuint mid, GLuint vertexBuffer, glm::mat4 mvp) {
	// Clear the screen
